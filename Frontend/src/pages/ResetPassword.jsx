...
import { Eye, EyeOff, Lock, KeyRound, ShieldAlert, ChevronLeft } from 'lucide-react';
...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post('/reset-password', { token, password, confPass });
            showToast(res.data.msg || 'Password reset successfully!', 'success');
            navigate('/login');
        } catch (err) {
            ...
            <div className="login-panel" style={{ margin: 'auto', maxWidth: '450px', width: '90%' }}>
                <form className="panel-card" onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginTop: '32px' }}>
                        <button className="btn-primary full rounded-full" type="submit" disabled={loading || !isPasswordValid}>
